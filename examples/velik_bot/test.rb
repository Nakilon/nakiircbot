...
fail unless "Куда продать %s: барахолка (среднее за неделю) - 27793 ₽, Терапевт - 8343 ₽"      == p(Common.method(:parse_response).(File.read "pevko.htm"))  # +барахолка -$
...
fail unless p(Common.price("кот"))[/\AКуда продать \"Статуэтка кота\": барахолка \(среднее за неделю\) - \d+ ₽, Терапевт - \d+ ₽, Миротворец - \d+ \$\z/]
