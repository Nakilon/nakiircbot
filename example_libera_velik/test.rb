...
Thread.new do
  ...
  begin
    ...
    fail unless "PRIVMSG #channel :https://esolangs.org/wiki/Bitwise%20Cyclic%20Tag https://esolangs.org/wiki/User:Nakilon https://esolangs.org/wiki/Velik https://esolangs.org/wiki/???\n" == client.gets
  rescue
    puts "TESTS FAILED"
    exit 1
  else
